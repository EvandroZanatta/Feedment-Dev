<?php
    ...
    $feed = file_get_contents('http://gdata.youtube.com/feeds/base/users/descealetra/uploads?orderby=updated&v=2&max-results=10');
    ...
    foreach($rss->entry as $entrada){
        ...
        if($query_verif_post_num_rows > 0){
            ...
            $link = $entrada->link['href'];
            $desc = $entrada->content;
